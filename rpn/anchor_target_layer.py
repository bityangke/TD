...
class AnchorTargetLayer(caffe.Layer):
    ...
    def forward(self, bottom, top):
        ...
        inds_inside = np.where(
            ...
            (all_anchors[:, 1] < length + self._allowed_border)  # width
        )[0]
        ...
        twin_inside_weights[labels == 1, :] = np.array(cfg.TRAIN.RPN_BBOX_INSIDE_WEIGHTS)
        ...
        twin_outside_weights = twin_outside_weights \
            .reshape((1, height, width, A * 2)).transpose(0, 4, 1, 2, 3)
